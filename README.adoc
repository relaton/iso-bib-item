...
iso191152.title(lang: "en").to_s
=> "Geographic information -- Metadata -- Part 1: Fundamentals"

iso191152.abstract(lang: "en").to_s
...
iso191152.dates.filter(type: "published").first.on
...
hit_collection[3].fetch.status
=> #<IsoBibItem::IsoDocumentStatus:0x007f983ba5e148
 @stage="60",
 @status=#<IsoBibItem::LocalizedString:0x007f983ba5e0f8 @content="Under development", @language=[], @script=[]>,
 @substage="00">
----

[source,ruby]
----
wg = iso191152.workgroup
