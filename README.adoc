...
image:https://img.shields.io/travis/metanorma/iso-bib-item/master.svg["Build Status", link="https://travis-ci.org/metanorma/iso-bib-item"]
...
IsoBib is a Ruby gem that implements the https://github.com/metanorma/metanorma-models-iso#iso-bibliographic-item[IsoBibliographicItem model].
